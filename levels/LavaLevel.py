...
class LavaLevel(Level):
    ...
    def __init__(self, screen):
        ...
        self.p1 = Platform(screen, 135, 510, 57, 290)
        self.p2 = Platform(screen, 261, 409, 51, 391)
        self.p3 = Platform(screen, 437, 315, 324, 485)
        self.p4 = Platform(screen, 823, 408, 58, 392)
        self.p5 = Platform(screen, 943, 495, 60, 306)
